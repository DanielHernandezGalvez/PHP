...
function gymfitness_clases_post_type()
{
	...
	$args = array(
		...
		'labels'                => $labels,
		'supports'              => array('title', 'editor', 'thumbnail', 'custom-fields'), // instalar advance custom fields en plugins (ACF para encontrar rápido, es el verde mentta) o en el array poner 'custom-fields'
